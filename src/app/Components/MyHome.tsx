      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full sm:mt-20">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            As an experienced front-end developer, I have an in-depth
            understanding of popular technologies including React, Next.js,
            Chakra UI, and Tailwind CSS. I love to work on web application using
            these technologies.
          </p>
