    ...
    <div className=' contact parent w-full h-screen bg-gradient-to-b from-black to-gray-800 text-white '>
        <div className='child  flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full '>
            ...
            <div className='child flex justify-center items-center'>
                <form action="https://getform.io/f/45ea5889-99eb-4b57-9c84-5f95412c6565" method="POST" className='flex flex-col w-full md:w-1/2'>
                    ...
                    <input type="email" name="email" placeholder='Enter your email' className='my-4 p-2 bg-transparent border-2 rounded-md
                     text-white focus:outline-none' />
                     <textarea rows={7} name="message" placeholder='Enter your message' className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'></textarea>
