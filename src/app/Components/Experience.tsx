...
export default function Experience() {
  ...
  return (
    <div name="experience" className='parent bg-gradient-to-b to-black from-gray-800 w-full h-screen  py-[600px]'>
        ...
        <div className='child max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white '>
            ...
            {techs.map(({id,src,title,style})=>(
                 <div key={id} className={`subchild shadow-md hover:scale-105 duration-500 py-2  rounded-lg ${style}`}>
                 <Image src={src} alt="experience" className='w-20 mx-auto'></Image>
